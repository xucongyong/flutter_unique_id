package com.reverse.flutter_unique_id;
...
/** FlutterUniqueIdPlugin */
public class FlutterUniqueIdPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_unique_id");
