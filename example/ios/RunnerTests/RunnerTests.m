...
- (void)testExample {
  OnlyUniqueDeviceIdPlugin *plugin = [[OnlyUniqueDeviceIdPlugin alloc] init];

  FlutterMethodCall *call = [FlutterMethodCall methodCallWithMethodName:@"getOnlyUniqueDeviceId"
                                                              arguments:nil];
